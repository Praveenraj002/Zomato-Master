    ...
    return(
        ...
        <div className="md:hidden flex items-center justify-between ">
               <div className="flex flex-col items-start">
                    ...
                    <h4>₹300 <span className="tex-gray-200">(plus tax)</span></h4>
                </div>
                <button className="flex items-center h-10 text-lg font-light text-white gap-1 bg-zomato-400 px-3 py-1 rounded-lg">
        ...
        <div className="hidden md:flex items-center justify-between container px-20 mx-auto">
               <div className="flex gap-2 text-xl items-start">
                ...
                <div className="flex items-center gap-2">
                     <h4 className="text-xl">Subtotal: ₹350</h4>
...
const CartContainer = () => {
    ...
    return (
        <>
       {
           isOpen && ( <div className="fixed w-full overflow-y-scroll h-48 bg-white z-10 p-2 bottom-16 px-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <FoodItem name="Chicken Briyani Regular" price="2" quantity="220"/>
              <FoodItem name="Chicken Briyani Regular" price="2" quantity="220"/>
              <FoodItem name="Chicken Briyani Regular" price="2" quantity="220"/>
